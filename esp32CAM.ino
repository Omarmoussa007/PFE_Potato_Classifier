...
// 🔴 A MODIFIER
const char* ssid = "NomWifi";          // ← ton WiFi
const char* password = "MotDePasse";   // ← ton mot de passe
const char* serverName = "http://10.13.176.43:5000/upload"; // ← IP PC
...
void loop() {
  ...
  delay(10000); // envoi chaque 10 secondes
}